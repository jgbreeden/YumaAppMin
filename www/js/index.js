...
/*         }else if (x >= 20 && x <= 68 && y >= 180 && y <= 235 ){ 
    ...
    getFeature: function(x, y) {
        ...
        if (x > 290 && x < 720 && y > 30 && y < 200){  
            ei = 0;
        }else if (x > 240 && x < 310 && y > 550 && y < 610) {
            ei = 1;
        }else if (x > 180 && x < 240 && y > 290 && y < 335) {
            ei = 2;
        } else if (x > 90 && x < 150 && y > 70 && y < 120) {
            ei = 3;
        } else if (x > 580 && x < 640 && y > 645 && y < 665) {
            ei = 4;
        } else if (x > 255 && x < 310 && y > 250 && y < 300) {
            ei = 5;
        } else if (x > 490 && x < 550 && y > 350 && y < 410) {
            ei = 5;
        } else if (x > 170 && x < 220 && y > 150 && y < 200) {
            ei = 6;
        } else if (x > 410 && x < 460 && y > 650 && y < 700) {
            ei = 6;
        } else {
            ei = -1
